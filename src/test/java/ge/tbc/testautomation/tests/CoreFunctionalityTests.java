...
public class CoreFunctionalityTests extends BaseTest {
    ...
    @Description("Verifies that the user can search for accommodations in a specific location and see correct search results.")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Description("Ensures that the user is able to select check-in and check-out dates from the calendar and view results.")
    @Link(name = "Booking App", url = "https://booking.com")
    ...
    @Description("Tests the filter functionality to ensure users can refine results by hotel type, rating, and payment policy.")
    @Link(name = "Booking App", url = "https://booking.com")
    ...
    @Description("Verifies that the user can sort the listing results based on review scores and that the sorting is correct.")
    @Link(name = "Booking App", url = "https://booking.com")
    @Test(priority = 4)
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Description("Checks that the property details shown in the listing match those shown on the property detail page.")
    @Link(name = "Booking App", url = "https://booking.com")
